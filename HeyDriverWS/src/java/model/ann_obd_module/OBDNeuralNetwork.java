...
public class OBDNeuralNetwork {
    ...
    public double[] firstNeuralNetwork (double air_fuel_ratio, double stft2, double stft1, double ltft2, double ltft1, double maf, double pressure_at){
        NeuralNetwork neuralNetwork = NeuralNetwork.createFromFile("C:\\Users\\crist\\Desktop\\HeyDriverFinaly\\Tesis-OBDII\\HeyDriverWS\\src\\java\\model\\ann_obd_module\\NeuralNetworksOBD\\FirstNeuralNetwork.nnet");
        // set network input 
    ...
    public double[] secondNeuralNetwork (double air_fuel_ratio, double timeadvance, double rpm, double stft2, double stft1, double ltft2, double ltft1, double maf, double coolant, double motorcharge){
        NeuralNetwork neuralNetwork = NeuralNetwork.createFromFile("C:\\Users\\crist\\Desktop\\HeyDriverFinaly\\Tesis-OBDII\\HeyDriverWS\\src\\java\\model\\ann_obd_module\\NeuralNetworksOBD\\SecondNeuralNetwork.nnet");
        // set network input 
    ...
    public double[] thirdNeuralNetwork (double air_fuel_ratio, double timeadvance, double rpm, double stft2, double stft1, double ltft2, double ltft1){
        NeuralNetwork neuralNetwork = NeuralNetwork.createFromFile("C:\\Users\\crist\\Desktop\\HeyDriverFinaly\\Tesis-OBDII\\HeyDriverWS\\src\\java\\model\\ann_obd_module\\NeuralNetworksOBD\\ThirdNeuralNetwork.nnet");
        // set network input 
    ...
    public double[] forthNeuralNetwork (double admission_temp, double coolant, double air_fuel_ratio, double stft2, double stft1, double ltft2, double ltft1, double timeadvance, double rpm){
        NeuralNetwork neuralNetwork = NeuralNetwork.createFromFile("C:\\Users\\crist\\Desktop\\HeyDriverFinaly\\Tesis-OBDII\\HeyDriverWS\\src\\java\\model\\ann_obd_module\\NeuralNetworksOBD\\ForthNeuralNetwork.nnet");
        // set network input 
