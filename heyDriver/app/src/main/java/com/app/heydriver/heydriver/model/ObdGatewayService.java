...
import com.app.heydriver.heydriver.model.ObdCommandJob.ObdCommandJobState;
...
/**
 * Created by Cristian on 9/2/2017.
 */
...
public class ObdGatewayService extends AbstractGatewayService {
    ...
    public static ObdReaderFragment obdFragment;
     ...
     */
            ...
            showNotification(getString(R.string.notification_action), getString(R.string.service_starting), R.drawable.ic_menu_car, true, true, false);
            ...
            showNotification(getString(R.string.notification_action), getString(R.string.service_started), R.drawable.ic_menu_car, true, true, false);
        }
    }
